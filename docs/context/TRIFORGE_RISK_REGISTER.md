...
**Last updated:** 2026-06-29 (Loop 23 — A6.5; A6 read-only routing — no new writable risk; learned rules are repo-scoped + evidence-gated, no auto-generalization per ADR 0049)
