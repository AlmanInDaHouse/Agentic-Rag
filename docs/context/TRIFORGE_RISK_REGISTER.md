...
**Last updated:** 2026-06-29 (Loop 26 — A8.1 Provider Status UI; honest states (no invented), sanitized untrusted content (XSS/terminal-escape/secret/hostile-filename), web vitest gate added per ADR 0052)
