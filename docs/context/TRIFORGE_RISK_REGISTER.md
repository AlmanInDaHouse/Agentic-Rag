...
**Last updated:** 2026-06-30 (Loop 40 — A9.7 Documentation; operator guide covers the full lifecycle (create/observe/audit/cancel/recover) + safety guarantees, cross-linked; docs-completeness test)
