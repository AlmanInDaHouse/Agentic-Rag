/**
 * Inline SVG icon set (A11 redesign) — no icon-library dependency. Each icon is a small
 * stroke glyph inheriting `currentColor` and sized via `size`. Feather-style geometry.
 */
...
function svg(children: React.ReactNode) {
  return function Icon({ size = 18, className, strokeWidth = 1.8, ...rest }: IconProps): JSX.Element {
    return (
      <svg
        className={className}
        width={size}
...
export const IconStop = svg(<rect x="5" y="5" width="14" height="14" rx="2" />);
...
export const IconChevron = svg(<polyline points="9 18 15 12 9 6" />);
